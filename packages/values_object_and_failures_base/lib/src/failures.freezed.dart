...
class _$EmptyOrNullCharacters<T> implements EmptyOrNullCharacters<T> {
...
class _$ServerError<F> implements ServerError<F> {
...
class _$NotConnection<F> implements NotConnection<F> {
...
class _$TimeOutExceeded<F> implements TimeOutExceeded<F> {
...
class _$LocalError<F> implements LocalError<F> {
